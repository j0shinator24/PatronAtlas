...
export async function sendWaitlistEmail(args: {
  ...
  const lines = [
    ...
    "2. In the meantime, the free tier (3 queries a month, no signup) goes live alongside Pro.",
    "3. If you want to share what you currently struggle with in funder research, just reply to this email. Real charity feedback shapes what gets built.",
    "",
    "Joshua",
    "PatronAtlas",
