  ...
  return (
    <article className="mx-auto max-w-3xl px-4 md:px-8 py-16 md:py-24 prose prose-neutral dark:prose-invert">
      ...
      <section className="mb-10">
        ...
        <ul className="text-sm leading-relaxed text-muted-foreground space-y-1 ml-5 list-disc">
          <li><strong>OpenRouter (United States), with the DeepSeek and Qwen models.</strong> When you use the matching tool, the charity description and details you enter are transmitted to OpenRouter Inc in the United States and processed by the DeepSeek model to generate your funder matches, with a lower-cost Qwen model used as a fallback when DeepSeek is unavailable. This is an overseas disclosure under APP 8. By submitting the tool you consent to this overseas disclosure (APP 8.2(b)). We use a free model tier with a low-cost paid fallback, and we cannot guarantee the overseas recipients are bound by the Australian Privacy Principles or that your input will not be used to improve their models. <strong>Do not paste confidential, sensitive, or unpublished information into the tool.</strong> Use only information your charity is comfortable sharing publicly.</li>
